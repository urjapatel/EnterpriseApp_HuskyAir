...
@Document(collection = "reservations")  // Fixed typo in collection name
...
public class Reservation {
 ...
 // Add getters and setters for the status field
    ...
    public Reservation(String id, String firstName, String lastName, int numberOfPassengers, 
                     String travelClass, String phoneNumber, LocalTime time, 
                     LocalDate dateOfDeparture, Customer customer, 
                     AirlineTicket ticket, Payment payment) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.numberOfPassengers = numberOfPassengers;
